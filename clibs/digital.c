...
extern int16 n_HVMFramework_Digital_Write(int32 *sp);
extern int16 n_HVMFramework_Digital_PinMode(int32 *sp);
extern int16 n_HVMFramework_Digital_read(int32 *sp);
